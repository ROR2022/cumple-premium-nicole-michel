...
export function ParentsScene({ onComplete, isActive = true }: ParentsSceneProps) {
  ...
  const secondMessage = "Parroquia de Santiago Apostol"
  const thirdMessage = "15:00 hrs."
  const fourthMessage = "Ayapango Edo. de Méx."
  const fifthMessage = "Ceremonia Religiosa"
  const ubiLink = "https://maps.app.goo.gl/o86aND8aykPjxU698"
