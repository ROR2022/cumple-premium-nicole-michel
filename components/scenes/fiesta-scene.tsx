...
const fiestaVideo = videoFondos.fiesta;

interface FiestaSceneProps {
  onComplete?: () => void
  isActive?: boolean
}

export function FiestaScene({ onComplete, isActive = true }: FiestaSceneProps) {
  ...
  /*
  Evento Parque Ecoturistico "El Galpón"
    Dirección Camino Ayapango, Pahuacan a un costado de la unidad deportiva de Ayapango
    */
  
  const firstMessage = "Recepción"
  const secondMessage = "Parque Ecoturistico El Galpón"
  const thirdMessage = "16:00 hrs."
  const fourthMessage = "Camino Ayapango, Pahuacan a un costado de la unidad deportiva de Ayapango"
  const fifthMessage = "Fiesta y Diversión"
  const ubiLink = "https://maps.app.goo.gl/UjJCtudY9eqZfmBu7"
  ...
  return (
    <div className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <source src={fiestaVideo.src} type="video/mp4" />
