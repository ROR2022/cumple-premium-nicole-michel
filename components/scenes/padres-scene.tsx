...
const padresVideo = videoFondos.padres
...
export function PadresScene({ onComplete, isActive }: PadresSceneProps) {
  ...
  const secondMessage = "Areli Natali Fragoso Benítez"
  const thirdMessage = "Eduardo Ramírez Sánchez"
  ...
  return (
    <div className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <source src={padresVideo.src} type="video/mp4" />
